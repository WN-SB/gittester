...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/GitLba-Test/petstore/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/GitLba-Test/petstore/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/GitLba-Test/petstore/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/GitLba-Test/petstore/1.0.0/pet/findByTags")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/GitLba-Test/petstore/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
